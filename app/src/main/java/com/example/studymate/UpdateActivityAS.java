...
public class UpdateActivityAS extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_update_as);
        ...
        button_update.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                MyCoreDatabase myDB = new MyCoreDatabase(UpdateActivityAS.this);
