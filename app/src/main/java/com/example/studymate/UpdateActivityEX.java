...
public class UpdateActivityEX extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_update_ex);
        ...
        button_update.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                MyCoreDatabase myDB = new MyCoreDatabase(UpdateActivityEX.this);
