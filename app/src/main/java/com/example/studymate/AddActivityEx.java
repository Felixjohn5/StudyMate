...
public class AddActivityEx extends AppCompatActivity {
    ...
    public void doSave(View view) {
        ...
        if (status) {
            ...
            myDate.setText("");
            myTime.setText("");
            Toast.makeText(getApplicationContext(), "Examination event saved successfully", Toast.LENGTH_SHORT).show();
        } else {
            Toast.makeText(getApplicationContext(), "Failed to save Exam details", Toast.LENGTH_SHORT).show();
        }
