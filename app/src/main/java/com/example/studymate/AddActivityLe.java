...
public class AddActivityLe extends AppCompatActivity {
    ...
    public void doSave(View view) {
        ...
        if (status) {
            ...
            myDate.setText("");
            myTime.setText("");
            Toast.makeText(getApplicationContext(), "Lecture event saved successfully", Toast.LENGTH_SHORT).show();
        } else {
            Toast.makeText(getApplicationContext(), "Failed to save Lecture details", Toast.LENGTH_SHORT).show();
        }
    }
