...
import com.example.studymate.AddActivityEx;
import com.example.studymate.CustomAdapterEX;
...
public class ExamsFragment extends Fragment {
    ...
    CustomAdapterEX customAdapterEX;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        add_button = view.findViewById(R.id.addButtonExams);
        ...
        add_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(getActivity(), AddActivityEx.class);
        ...
        customAdapterEX = new CustomAdapterEX(getActivity(), getContext(),
                event_id, event_title, event_course, event_type, event_description, event_date, event_time);
        recyclerView.setAdapter(customAdapterEX);
    ...
    public void onActivityResult(int requestCode, int resultCode, @Nullable @org.jetbrains.annotations.Nullable Intent data) {
        ...
        if(requestCode == 1){
            getFragmentManager().beginTransaction().detach(ExamsFragment.this).attach(ExamsFragment.this).commit();
        }
    }
