...
public class AddActivityA extends AppCompatActivity {
    ...
    public void doSave(View view) {
        ...
        if (status) {
            ...
            myDate.setText("");
            myTime.setText("");
            Toast.makeText(getApplicationContext(), "Assignment saved successfully", Toast.LENGTH_SHORT).show();
        } else {
            Toast.makeText(getApplicationContext(), "Failed to save Assignment details", Toast.LENGTH_SHORT).show();
        }
